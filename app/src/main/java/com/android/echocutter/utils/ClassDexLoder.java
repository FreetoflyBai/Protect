...
public class ClassDexLoder extends DexClassLoader {

    private static final String TAG = ClassDexLoder.class.getName();
     ...
     * @param parent
     */
    public ClassDexLoder(String dexPath, String optimizedDirectory,
    ...
    public ClassDexLoder(Context context, byte[] dexBytes,
