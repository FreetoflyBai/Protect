...
#-libraryjars <java.home>/usr/local/android-sdk/platforms/android-9/android.jar
#-libraryjars /usr/local/android-sdk/add-ons/google_apis-7_r01/libs/maps.jar
#-libraryjars <android.home>/platforms/android-21/android.jar
#-libraryjars D:/ProgramFiles/Android/sdk1/platforms/android-21/android.jar
# ...

# Save the obfuscation mapping to a file, so you can de-obfuscate any stack
# traces later on.

#-printmapping classes-processed.map #输出混淆名称对应表
