...
import com.library.dexknife.doaction.Constant;
...
import com.library.dexknife.shell.utils.FileHelper;
import com.library.dexknife.shell.utils.StringUtils;
...
//    public static  String FRAMEWORK_RES = "framework-res.apk";
    public static  String APKTOOL_JAR_PATH = Constant.APKTOOL_PATH;
    public static  String APKTOOLJARPATH = null;
    private static File apkTool = new File(APKTOOL_JAR_PATH);
