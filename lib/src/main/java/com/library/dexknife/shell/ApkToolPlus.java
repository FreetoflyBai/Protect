package com.library.dexknife.shell;
...
public class ApkToolPlus {
    ...
    public static boolean class2dex(File classesDir, String outputDexPath){
        ...
        if (!com.library.dexknife.shell.utils.FileHelper.makePath(outputDexPath)){
    ...
    public static boolean smali2dex(String smaliDirPath, String dexOutputPath){
        ...
        if (!com.library.dexknife.shell.utils.FileHelper.makePath(dexOutputPath)){
    ...
    public static File signApk(File apk, KeystoreConfig config){
        ...
        com.library.dexknife.shell.utils.FileHelper.delete(apkCopy);

        com.library.dexknife.shell.utils.FileHelper.copyFile(apk,apkCopy);
        com.library.dexknife.shell.utils.ZipHelper.removeFileFromZip(apkCopy,"META-INF");

        File signedApk = new File(apk.getParentFile(), com.library.dexknife.shell.utils.FileHelper.getNoSuffixName(apk) + ".apk");
        com.library.dexknife.shell.utils.FileHelper.delete(signedApk);
