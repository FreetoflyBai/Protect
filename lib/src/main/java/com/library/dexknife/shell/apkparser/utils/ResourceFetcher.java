...
public class ResourceFetcher {
    ...
    private void fetchSystemStyle() throws IOException {
        ...
        for (String line : lines) {
            ...
            if (line.startsWith("field public static final")) {
                line = com.library.dexknife.shell.apkparser.utils.Utils.substringBefore(line, ";").replace("deprecated ", "")
    ...
    private String getUrl(String url) throws IOException {
        ...
        try {
            ...
            byte[] bytes = com.library.dexknife.shell.apkparser.utils.Utils.toByteArray(conn.getInputStream());
