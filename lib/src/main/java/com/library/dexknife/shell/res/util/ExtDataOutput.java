package com.library.dexknife.shell.res.util;
...
public class ExtDataOutput extends DataOutputDelegate {
    ...
    public void writeBytes(com.library.dexknife.shell.res.util.ExtDataInput in, int length) throws IOException {
    ...
    public void writeCheckChunkTypeInt(com.library.dexknife.shell.res.util.ExtDataInput reader, int expected, int possible) throws IOException {
