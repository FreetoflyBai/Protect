...
import com.library.dexknife.shell.apkparser.bean.GlEsVersion;
import com.library.dexknife.shell.apkparser.bean.UseFeature;
...
public class ApkMetaTranslator implements XmlStreamer {
    ...
    @Override
    public void onStartTag(com.library.dexknife.shell.apkparser.struct.xml.XmlNodeStartTag xmlNodeStartTag) {
        com.library.dexknife.shell.apkparser.struct.xml.Attributes attributes = xmlNodeStartTag.getAttributes();
        switch (xmlNodeStartTag.getName()) {
            ...
            case "uses-permission":
                ...
                break;
            case "permission":
                com.library.dexknife.shell.apkparser.bean.Permission permission = new com.library.dexknife.shell.apkparser.bean.Permission();
    ...
    @Override
    public void onCData(com.library.dexknife.shell.apkparser.struct.xml.XmlCData xmlCData) {

    }

    @Override
    public void onNamespaceStart(com.library.dexknife.shell.apkparser.struct.xml.XmlNamespaceStartTag tag) {
