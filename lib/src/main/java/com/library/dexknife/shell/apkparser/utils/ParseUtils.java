package com.library.dexknife.shell.apkparser.utils;
...
import com.library.dexknife.shell.apkparser.struct.resource.Type;
...
public class ParseUtils {
     ...
     */
    public static com.library.dexknife.shell.apkparser.struct.StringPool readStringPool(ByteBuffer buffer, StringPoolHeader stringPoolHeader) {
        ...
        com.library.dexknife.shell.apkparser.parser.StringPoolEntry[] entries = new com.library.dexknife.shell.apkparser.parser.StringPoolEntry[offsets.length];
        for (int i = 0; i < offsets.length; i++) {
            entries[i] = new com.library.dexknife.shell.apkparser.parser.StringPoolEntry(i, stringPos + offsets[i]);
        }

        String lastStr = null;
        long lastOffset = -1;
        com.library.dexknife.shell.apkparser.struct.StringPool stringPool = new com.library.dexknife.shell.apkparser.struct.StringPool((int) stringPoolHeader.getStringCount());
        for (com.library.dexknife.shell.apkparser.parser.StringPoolEntry entry : entries) {
     ...
     */
    public static ResourceEntity readResValue(ByteBuffer buffer, com.library.dexknife.shell.apkparser.struct.StringPool stringPool) {
        com.library.dexknife.shell.apkparser.struct.ResValue resValue = new com.library.dexknife.shell.apkparser.struct.ResValue();
        ...
        switch (resValue.getDataType()) {
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_DEC:
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_HEX:
                resValue.setData(new ResourceEntity(buffer.getInt()));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.STRING:
                int strRef = buffer.getInt();
                if (strRef >= 0) {
                    resValue.setData(new ResourceEntity(stringPool.get(strRef)));
                }
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.REFERENCE:
                long resourceId = Buffers.readUInt(buffer);
                resValue.setData(new ResourceEntity(resourceId));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_BOOLEAN:
                resValue.setData(new ResourceEntity(buffer.getInt() != 0));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.NULL:
                resValue.setData(new ResourceEntity(""));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_COLOR_RGB8:
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_COLOR_RGB4:
                resValue.setData(new ResourceEntity(readRGBs(buffer, 6)));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_COLOR_ARGB8:
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.INT_COLOR_ARGB4:
                resValue.setData(new ResourceEntity(readRGBs(buffer, 8)));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.DIMENSION:
                resValue.setData(new ResourceEntity(getDimension(buffer)));
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResType.FRACTION:
    ...
    private static String getDimension(ByteBuffer buffer) {
        ...
        String unitStr;
        switch (unit) {
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_MM:
                unitStr = "mm";
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_PX:
                unitStr = "px";
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_DIP:
                unitStr = "dp";
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_SP:
                unitStr = "sp";
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_PT:
                unitStr = "pt";
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_IN:
                unitStr = "in";
                break;
            default:
    ...
    private static String getFraction(ByteBuffer buffer) {
        ...
        String pstr;
        switch (type) {
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_FRACTION:
                pstr = "%";
                break;
            case com.library.dexknife.shell.apkparser.struct.ResValue.ResDataCOMPLEX.UNIT_FRACTION_PARENT:
                pstr = "%p";
                break;
            default:
    ...
    public static void checkChunkType(int expected, int real) {
        if (expected != real) {
            throw new com.library.dexknife.shell.apkparser.exception.ParserException("Expect chunk type:" + Integer.toHexString(expected)
     ...
     */
    public static String getResourceById(long resourceId, com.library.dexknife.shell.apkparser.struct.resource.ResourceTable resourceTable, Locale locale) {
...
//        a 16-bit Entry index [bits 0-15]
        ...
        if (resourceId > AndroidConstants.SYS_STYLE_ID_START && resourceId < AndroidConstants.SYS_STYLE_ID_END) {
            return "@android:style/" + com.library.dexknife.shell.apkparser.struct.resource.ResourceTable.sysStyle.get((int) resourceId);
        }
        ...
        com.library.dexknife.shell.apkparser.struct.resource.ResourcePackage resourcePackage = resourceTable.getPackage(packageId);
        if (resourcePackage == null) {
            return str;
        }
        com.library.dexknife.shell.apkparser.struct.resource.TypeSpec typeSpec = resourcePackage.getTypeSpec(typeId);
        ...
        com.library.dexknife.shell.apkparser.struct.resource.ResourceEntry resource = null;
        String ref = null;
        int currentLevel = -1;
        for (Type type : types) {
            com.library.dexknife.shell.apkparser.struct.resource.ResourceEntry curResource = type.getResourceEntry(entryIndex);
            if (curResource == null) {
                continue;
            }
            ...
            int level = com.library.dexknife.shell.apkparser.bean.Locales.match(locale, type.getLocale());
            if (level == 2) {
