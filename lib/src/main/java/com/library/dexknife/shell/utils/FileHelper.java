...
public class FileHelper {
    ...
    public static void recusive(File file, com.library.dexknife.shell.utils.FileHandler fileHandler){
    ...
    public static void showInExplorer(String path){
        if (com.library.dexknife.shell.utils.StringUtils.isEmpty(path)) return;
        if(com.library.dexknife.shell.utils.OS.isWindows()){
           com.library.dexknife.shell.utils.Cmd.exec("explorer.exe /select," + path);
        }else{
            // linux/mac
            com.library.dexknife.shell.utils.Cmd.exec("open " + path);
        }
    }
