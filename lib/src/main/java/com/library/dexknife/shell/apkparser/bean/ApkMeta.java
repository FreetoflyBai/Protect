...
public class ApkMeta {
    ...
    private List<com.library.dexknife.shell.apkparser.bean.UseFeature> usesFeatures = new ArrayList<>();
    ...
    public List<com.library.dexknife.shell.apkparser.bean.UseFeature> getUsesFeatures() {
        return usesFeatures;
    }

    public void addUseFeatures(com.library.dexknife.shell.apkparser.bean.UseFeature useFeature) {
