...
public class ResourceMapEntry extends ResourceEntry {
    ...
    private com.library.dexknife.shell.apkparser.struct.resource.ResourceTableMap[] resourceTableMaps;
    ...
    public com.library.dexknife.shell.apkparser.struct.resource.ResourceTableMap[] getResourceTableMaps() {
        return resourceTableMaps;
    }

    public void setResourceTableMaps(com.library.dexknife.shell.apkparser.struct.resource.ResourceTableMap[] resourceTableMaps) {
