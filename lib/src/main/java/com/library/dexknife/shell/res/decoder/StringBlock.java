...
public class StringBlock {
     ...
     */
    public static StringBlock read(com.library.dexknife.shell.res.util.ExtDataInput reader) throws IOException {
    ...
    public static int writeSpecNameStringBlock(com.library.dexknife.shell.res.util.ExtDataInput reader, com.library.dexknife.shell.res.util.ExtDataOutput out, HashSet<String> specNames, Map<String, Integer> curSpecNameToPos) throws IOException, AndrolibException {
    ...
    public static int writeTableNameStringBlock(com.library.dexknife.shell.res.util.ExtDataInput reader, com.library.dexknife.shell.res.util.ExtDataOutput out, Map<Integer, String> tableProguardMap) throws IOException, AndrolibException {
        int type = reader.readInt();
        int chunkSize = reader.readInt();
        int stringCount = reader.readInt();
        int styleOffsetCount = reader.readInt();
     ...
     */
    public static void writeAll(com.library.dexknife.shell.res.util.ExtDataInput reader, com.library.dexknife.shell.res.util.ExtDataOutput out) throws IOException {
